...
struct FloatVec2
{
    ...
    // overload negative sign operator
    FloatVec2 operator-() const
    {
        return FloatVec2(-this->first, -this->second);
    }
...
struct FloatVec3
{
    ...
    // overload negative sign operator
    FloatVec3 operator-() const
    {
        return FloatVec3(-this->first, -this->second, -this->third);
    }
